            ...
            <Fragment>
                ...
                <div style={{ width: '100%', marginBottom: '10px' }}>
                    <MaterialTable
                        ...
                        icons={{
                            Add: forwardRef((props, ref) => <div style={{ display: 'flex' }}><AddIcon {...props} ref={ref} color="primary" fontSize="default" viewBox="0 0 20 20" /><p style={{ fontSize: 14, color: "#3f51b5" }}>Add Inventory Item</p></div>),
