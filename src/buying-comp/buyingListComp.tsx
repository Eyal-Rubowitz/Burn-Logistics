        ...
        return (
            <Fragment>
                <div style={{ width: '100%', paddingTop: 0 }}>
                    ...
                    <div style={{ border: 'solid 1px #D3D3D3', borderRadius: '5px', marginBottom: '10px', height: 135 }}>
                        <h2 style={{ textDecoration: "underline", marginLeft: '50px' }}>Filters</h2>
                        <div id="combo-box-filters" style={{ display: 'flex', marginLeft: 40 }}>
                            <Autocomplete
                    ...
                    <MaterialTable
                        title={<h2 style={{ marginLeft: '30px', textDecoration: "underline",fontWeight: 'bolder'}}>Shopping List</h2>}
                        columns={[
                            {
                                ...
                                render: (ing: Ingredient) => (!this.revealIsBoughtCol) ? null : (!this.isObjId(ing.getInvIdByItem)) ? <Checkbox
                                    ...
                                    color="primary" style={{ height: '5px' }} /> : <Typography variant='h6' color='primary' style={{fontWeight: 'bolder'}}>Purchase Done</Typography>,
                                type: 'boolean' || 'string'
                            },
                            {
                                title: 'Ingredient',
                    ...
                    <div style={{ marginTop: '10px' }}>
                        <Button variant="outlined" color="primary" onClick={() => { this.onSendItemsToInventory() }}>
