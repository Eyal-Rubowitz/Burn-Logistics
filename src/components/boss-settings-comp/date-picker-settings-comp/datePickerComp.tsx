                ...
                <Paper className="paper">
                    <div className="btnAddDate">
                        ...
                        <DayPickerInput
                            ...
                            inputProps={{ style: { marginLeft: 4 ,width: 150, height: 30, fontSize: 18, textAlign: 'center', fontWeight: 'bolder' } }}
                        />
                    </div>
                    <div>
                        <Typography variant="h6" className="title">Meal Days</Typography>
                        {mealDateList}
                    </div>
                </Paper>
            </>
